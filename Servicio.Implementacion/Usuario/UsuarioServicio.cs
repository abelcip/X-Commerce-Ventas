namespace Servicio.Implementacion.Usuario
{
    ...
    public class UsuarioServicio : IUsuarioServicio
    {
        ...
        public void Add(List<UsuarioDto> empleados)
        {
            ...
            {
                // transaccion: se graban todos o nada
                try
                {
        ...
        private string ObtenerNombreUsuario(string apellido, string nombre)
        {
            ...
            // trin: saca los espacios en blanco
            // tolower: lo pone todo en minusculas
            // substring: extraeme la cantidad de letras. en este caso 1
            // y los uno con el apellido
            ...
            // %%%%%%%%%%%%%   Esta Consulta es tal da error y salta  %%%%%%%%%%%%%%
            // comparo si hay otro nombreUsuario 
            //while (_unidadDeTrabajo.UsuarioRepositorio.Obtener(filtro).Any())
            //{
            //    contadorLetras++;
            //    // toma otra letra del nombre y lo une con el apellido
